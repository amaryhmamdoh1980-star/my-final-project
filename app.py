...
def chat():
    ...
    2. אם ביקשו תמונה, נסה לספק קישור ישיר לתמונה מ-Wikimedia Commons בפורמט Markdown.
    3. כל הקישורים חייבים להיות בפורמט: [שם](כתובת).
    4. בצע ניתוח מעמיק אם נשלחה אליך תמונה מהמשתמש.
