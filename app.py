...
def chat():
    ...
    2. אם ביקשו תמונה, שלח אותה בפורמט Markdown כך: ![תיאור](כתובת ה-URL). 
       השתמש בקישורים ישירים בלבד (למשל מ-Wikimedia) כדי שהתמונה תופיע בתוך הצ'אט.
    3. אם המשתמש שלח תמונה, נתח אותה במקצועיות.
    4. זכור את תוכן השיחה הקודם כדי לענות על שאלות המשך.
